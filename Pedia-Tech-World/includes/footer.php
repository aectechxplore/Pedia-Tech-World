        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="https://www.linkedin.com/in/pedia-tech-world-5aa1623a0/" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition" title="LinkedIn">
                        <i data-lucide="linkedin" class="w-4 h-4"></i>
                    </a>
                    <a href="https://www.instagram.com/pediatechworld?igsh=ZGNlbG9kdjFjOHJi" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-pink-600 hover:text-white transition" title="Instagram">
                        <i data-lucide="instagram" class="w-4 h-4"></i>
                    </a>
                    <a href="https://youtube.com/@pediatechworld?si=t-v9EJguyYmYDNYg" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-red-600 hover:text-white transition" title="YouTube">
                        <i data-lucide="youtube" class="w-4 h-4"></i>
                    </a>
                    <a href="https://www.facebook.com/share/1CzBz9iccw/" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-blue-500 hover:text-white transition" title="Facebook">
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start">
                        ...
                        <div class="flex flex-col">
                            <a href="mailto:contact@pediatech.com" class="hover:text-white transition">pediatechworld@gmail.com</a>
                    ...
                    <li class="flex items-start">
                        ...
                        <div class="flex flex-col">
                            <a href="tel:+919876543210" class="hover:text-white transition">+91 93635 34963</a>
