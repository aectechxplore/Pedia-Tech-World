        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex space-x-6 items-center text-sm font-medium">
                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo $root; ?>employee/dashboard.php" class="bg-red-600 px-4 py-2 rounded-md flex items-center gap-2 hover:bg-orange-500 transition">My Dashboard</a>
                    <?php endif; ?>
                <?php else: ?>
